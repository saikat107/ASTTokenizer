<METHOD_START> public void ( HttpServletResponse org.springframework.mock.web.test.HttpServletResponse ) { this( org.springframework.mock.web.test.HttpServletResponse , null ); }  <METHOD_END>
<METHOD_START> public void ( java.io.Writer java.io.Writer ) { this( null , java.io.Writer ); }  <METHOD_END>
<METHOD_START> public void ( HttpServletResponse org.springframework.mock.web.test.HttpServletResponse , java.io.Writer java.io.Writer ) { super( DEFAULT_BUFFER , true ); this . org.springframework.mock.web.test.HttpServletResponse = ( org.springframework.mock.web.test.HttpServletResponse != null ? org.springframework.mock.web.test.HttpServletResponse : new MockHttpServletResponse ( ) ) ; if ( java.io.Writer instanceof java.io.PrintWriter ) { this . java.io.PrintWriter = ( java.io.PrintWriter ) java.io.Writer ; } else if ( java.io.Writer != null ) { this . java.io.PrintWriter = new java.io.PrintWriter ( java.io.Writer ) ; } }  <METHOD_END>
<METHOD_START> protected java.io.PrintWriter java.io.PrintWriter ( ) java.io.IOException { if ( this . java.io.PrintWriter == null ) { this . java.io.PrintWriter = this . org.springframework.mock.web.test.HttpServletResponse . getWriter ( ) ; } return this . java.io.PrintWriter ; }  <METHOD_END>
<METHOD_START> @ java.lang.Override public void void ( ) java.io.IOException { if ( this . org.springframework.mock.web.test.HttpServletResponse . isCommitted ( ) ) { throw new java.io.IOException ( STRING ) ; } this . org.springframework.mock.web.test.HttpServletResponse . resetBuffer ( ) ; }  <METHOD_END>
<METHOD_START> @ java.lang.Override public void void ( ) java.io.IOException {	}  <METHOD_END>
<METHOD_START> @ java.lang.Override public void void ( ) java.io.IOException { this . org.springframework.mock.web.test.HttpServletResponse . flushBuffer ( ) ; }  <METHOD_END>
